...
const createDesktopBridgeStub = (overrides?: {
  ...
  return {
    ...
    trelloGetSnapshot: vi.fn().mockResolvedValue({
    ...
    trelloUpdateSettings: vi.fn().mockResolvedValue({
      settings: { hasApiKey: false, hasToken: false, updatedAt: null },
      boards: [],
      activeBoardId: null,
      cache: { board: null, lists: [], cards: [], labels: [], members: [], syncedAt: null },
    ...
    trelloListBoards: vi.fn().mockResolvedValue({ boards: [] }),
    trelloSelectBoard: vi.fn().mockResolvedValue({
      settings: { hasApiKey: false, hasToken: false, updatedAt: null },
      boards: [],
      activeBoardId: null,
      cache: { board: null, lists: [], cards: [], labels: [], members: [], syncedAt: null },
    ...
    trelloTestConnection: vi.fn().mockResolvedValue({ ok: true, message: "ok" }),
    trelloSyncBoard: vi.fn().mockResolvedValue({
      boardId: "board",
    ...
    trelloRetryJob: vi.fn().mockRejectedValue(new Error("trelloRetryJob not implemented")),
    trelloRemoveJob: vi.fn().mockResolvedValue(undefined),
    trelloCleanupJob: vi.fn().mockRejectedValue(new Error("trelloCleanupJob not implemented")),
    onCloudAuthCallback: () => () => {},
    onMenuAction: () => () => {},
